        ...
        <div class="col-md-12">
            <div class="customers__area bg-style mb-30">
                <div class="item-title">
                    <div class="col-xs-6">
                        <a href="{{route('admin.create_menu')}}" class="btn btn-md btn-info">{{ __('Add Dynamic Menu')}}</a>
                    </div>
                </div>
                    ...
                    <table id="BlogTable" class="dataTableHover row-border data-table-filter table-style">
                        ...
                        @forelse ($menus as $menu)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.edit_menu', encrypt($menu->id))}}" class="btn-action me-2"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <a href="{{route('admin.delete_menu', encrypt($menu->id))}}" class="btn-action delete"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        @empty
                            <tr>
